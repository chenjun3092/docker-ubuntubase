...
ADD https://github.com/coreos/etcd/releases/download/v2.0.0/etcd-v2.0.0-linux-amd64.tar.gz /opt/sources/
RUN tar xzf /opt/sources/etcd-v2.0.0-linux-amd64.tar.gz -C /usr/local/bin etcd-v2.0.0-linux-amd64/etcdctl --strip-components=1 && \
	rm /opt/sources/etcd-v2.0.0-linux-amd64.tar.gz
